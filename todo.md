...
- [ ] **[SOUS-MENU / HYPOTHÈSE]** Auto-détecter SAR/DAR/dimensions/orientation et signaler valeurs incertaines ; jamais déformer par défaut le lecteur brut déjà correct.
- [ ] **[SOUS-MENU / HYPOTHÈSE]** Concevoir dans les menus des losanges keyframes des sélecteurs SAR et DAR, Auto par défaut, override manuel optionnel et retour Auto. Étudier périmètre temporel/clip et transitions d'override sans réinterpréter arbitrairement les keyframes créatives.
- [ ] **[SOUS-MENU / HYPOTHÈSE]** Si variations réelles de géométrie, proposer à Fab une copie de travail normalisée par export/transcodage avant montage pour stabilité/fluidité potentielle, sur consentement explicite, sans détruire source, projet ou repères temporels ; vérifier coût disque/qualité/codec/audio.
- [ ] **[SOUS-MENU / HYPOTHÈSE]** Tester comparativement Auto, SAR/DAR manuels aux losanges, source constante ou variable et copie normalisée, en aperçu animé ET MP4 ; ne pas annoncer solution certaine avant essais.
